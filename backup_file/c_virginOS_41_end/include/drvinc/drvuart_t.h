...
* 公众号：技术乱舞
* https://aeneag.xyz
* filename: drvuart_t.h
* description:串口驱动头文件
************************************************************************************************/
#ifndef _DRVUART_T_H
#define _DRVUART_T_H
typedef struct KBOARD
{
    list_h_t kb_list;
    uint_t kb_flg;
    uint_t kb_stus;
...
#define DEV_KEYBOARD_NR (INT_VECTOR_IRQ0+1)
#define DEV_KEYBOARD_SUBDEV_NR 0
#define DEV_KEYBOARD_NAME "key_board"
...
#define KEYBOARD_INTLINE (INT_VECTOR_IRQ0+1)
