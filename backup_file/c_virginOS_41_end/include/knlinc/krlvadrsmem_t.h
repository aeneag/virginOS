...
//公众号：技术乱舞
//https://aeneag.xyz
//filename:krlvadrsmem_t.h
//description: 内核虚拟地址空间头文件
...
{
	spinlock_t kvs_lock;            //保护自身自旋锁
	u64_t  kvs_flgs;				//标志
	uint_t kvs_kmvdscnr;			//数量
	...
	adr_t kvs_isalcstart;           //内核所有虚拟  开始地址
	adr_t kvs_isalcend;				//内核所有虚拟 结束地址
	void* kvs_privte;
	void* kvs_ext;
