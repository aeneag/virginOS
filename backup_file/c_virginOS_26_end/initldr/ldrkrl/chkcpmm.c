...
void init_mem(machbstart_t *mbsp)
{
    ...
    mbsp->mb_e820padr = (u64_t)((u32_t)(retemp));//把e820map_t结构数组的首地址传给mbsp->mb_e820pad
...
void init_chkcpu(machbstart_t *mbsp)
{
    ...
    mbsp->mb_cpumode = 0x40;//如果成功就设置机器信息结构cpu模式为64位
    return;
}
...
void init_bstartpages(machbstart_t *mbsp)
{
    ...
    u64_t *pde = (u64_t *)(KINITPAGE_PHYADR + 0x2000);// page 目录
